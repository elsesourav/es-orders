...
function IndexPage() {
  const renderContent = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Options Page Content" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-dark-dotted pl-22", children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-5xl mx-auto px-4 py-8 custom-scrollbar overflow-y-auto max-h-screen", children: renderContent() }) });
}
const container = document.getElementById("options-root");
const root = clientExports.createRoot(container);
root.render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(IndexPage, {}) })
);
