...
import { getMarketplaceInfo } from "../utils/utils";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isActive && orderItemsCount > 1 && (
          <div className="w-full mt-3 rounded-md border border-gray-200 dark:border-gray-700 bg-white/70 dark:bg-gray-900/40">
            ...
            <div className="overflow-auto max-h-40">
              <table className="w-full text-xs">
                <thead className="bg-gray-100/70 dark:bg-gray-800/70 text-gray-700 dark:text-gray-200">
                  <tr>
                    <th className="px-2 py-1 text-left font-semibold">Image</th>
