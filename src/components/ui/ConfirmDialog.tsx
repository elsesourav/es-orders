...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className={`theme-card rounded-2xl shadow-2xl max-w-xs w-full px-4 py-6 relative flex flex-col items-center transform transition-all duration-300 border theme-border ${
          isVisible
